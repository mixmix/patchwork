  ...
  render: function() {
    return <div id="browser-navbar">
      ...
      <div className="input-group">
        ...
        <BrowserNavbarBtn title="Other Versions" icon="code-fork" onClick={this.props.onClickVersions} disabled={!this.props.page.canRefresh} />
        <BrowserNavbarBtn title="Bundle Contents" icon="sitemap" onClick={this.props.onClickBundles} disabled={!this.props.page.canRefresh} />
      </div>
